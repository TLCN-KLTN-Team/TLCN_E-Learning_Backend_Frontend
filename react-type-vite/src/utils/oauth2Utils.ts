export const OAuth2Utils = {
  callBackUrl: `${import.meta.env.VITE_LOCALHOST_URL}/auth/google/callback`,
...
export const FacebookOAuth2Utils = {
  ...
  fbRedirectUri: `${import.meta.env.VITE_LOCALHOST_URL}/auth/facebook/callback`, // Replace with your redirect URI
};
