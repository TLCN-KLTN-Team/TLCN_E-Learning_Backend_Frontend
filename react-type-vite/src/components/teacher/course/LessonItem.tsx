...
import { GripVertical, FileVideo, Star, Edit, Trash, Paperclip, Clock } from "lucide-react"
...
const LessonItem: React.FC<LessonItemProps> = ({ lesson, index, onDelete, onReorder, onEdit }) => {
