...
const SystemStatistics: React.FC = () => {
  ...
  useEffect(() => {
    if (chartRef.current) {
      ...
      if (ctx) {
        ...
        const data = [1200, 1350, 1500, 1800, 2100, 2400, 2800, 3200, 3600, 4000, 4500, 5000]
  ...
  const stats = [
    { label: "Tổng người dùng", value: "12,450", change: "+8.2%", color: "blue" },
    { label: "Đơn vị đào tạo", value: "24", change: "+2", color: "green" },
    { label: "Khóa học", value: "1,285", change: "+15.3%", color: "purple" },
    { label: "Doanh thu tháng", value: "6.45M VNĐ", change: "+12.5%", color: "yellow" },
  ]
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-4">
          ...
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg">Xuất báo cáo</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <canvas ref={chartRef} width={400} height={200} className="w-full"></canvas>
        </div>

        <div className="bg-white p-6 rounded-lg shadow">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Top đơn vị theo doanh thu</h3>
          <div className="space-y-4">
            {[
              { name: "Trung tâm CNTT", revenue: "2.5M VNĐ", percentage: 38.5 },
              { name: "Học viện Kinh doanh", revenue: "1.8M VNĐ", percentage: 27.9 },
              { name: "Trường Ngoại ngữ", revenue: "1.2M VNĐ", percentage: 18.6 },
              ...
              <div key={index} className="flex items-center justify-between">
                <div className="flex-1">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-sm text-gray-500">{unit.revenue}</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className="bg-blue-600 h-2 rounded-full" style={{ width: `${unit.percentage}%` }}></div>
                  </div>
                </div>
              </div>
            ))}
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        ...
        <div className="divide-y divide-gray-200">
          {[
            ...
            { action: "Khóa học mới", detail: "React Advanced được thêm bởi Trung tâm CNTT", time: "4 giờ trước" },
            {
              action: "Thanh toán thành công",
              detail: "Học viện Kinh doanh đã thanh toán hoa hồng tháng 1",
              time: "6 giờ trước",
            },
            { action: "Tài khoản mới", detail: "15 tài khoản học viên mới được tạo", time: "8 giờ trước" },
          ].map((activity, index) => (
