...
import EditCourseNavigationSidebar from "@/components/teacher/course/EditCourseNavigationSidebar"
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="px-6 py-4 flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-semibold text-gray-900">{courseData.courseName}</h1>
              <p className="text-sm text-gray-500">{courseData.credits} tín chỉ • {courseData.currentStudents} sinh viên</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="flex-grow flex">
        ...
        <div className="flex-1 overflow-auto">
          <div className="p-8">
            ...
            {activeTab === "class" && (
              <div>
                <ClassManagement courseId={courseId || ""} educationalUnitId={educationalUnitId ? Number(educationalUnitId) : null} />
              </div>
            )}
