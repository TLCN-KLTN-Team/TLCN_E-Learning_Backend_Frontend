...
const StudentListPage: React.FC = () => {
  ...
  const loadStudents = async (page: number = currentPage, size: number = pageSize, search?: string) => {
    if (!educationalUnitId) return;
    
    try {
      setLoading(true);
      const response: PaginatedResponse<StudentResponse> = await studentApi.getStudents(
        educationalUnitId, 
        page, 
        size
      );
  ...
  const handleToggleAccountStatus = async (student: StudentResponse) => {
    ...
    if (window.confirm(`Bạn có chắc chắn muốn ${action} tài khoản của "${student.firstName} ${student.lastName}"?`)) {
      try {
        await studentApi.updateStudentAccountStatus(educationalUnitId!, student.id, newStatus);
    ...
    <div className="p-6 space-y-6">
                    ...
                    <tr key={student.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex space-x-2">
                          ...
                          >
                            {student.accountStatus === 'ACTIVE' ? <Lock size={14} /> : <Unlock size={14} />}
                          </Button>
                          <Button
                            size="sm"
                            variant="outline"
      ...
      {showDetailModal && selectedStudent && (
        <StudentDetailModal
          ...
          onToggleStatus={() => {
            handleToggleAccountStatus(selectedStudent);
          }}
        />
      )}
          ...
          <div className="flex justify-between items-start">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm mt-1">@{student.username}</p>
                <div className="mt-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">
                    {student.className || <span className="text-gray-400 italic">Chưa phân lớp</span>}
                  </p>
                </div>
              </div>
              <div className="flex items-start col-span-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">
                    {student.department?.name || <span className="text-gray-400 italic">Chưa có khoa</span>}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-indigo-50 rounded-lg p-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">{student.educationalUnit.name}</p>
                </div>
              </div>
            </div>
          )}
