...
import Header from "@/components/student/shared/Header";
import Footer from "@/components/student/shared/Footer";
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#24292d]">
      {/* Header */}
      ...
      <main>
        ...
        <section className="py-12 lg:py-16 px-6 lg:px-8">
          <div className="container mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div>
                <h2 className="text-2xl md:text-3xl font-bold text-[#24292d] dark:text-white mb-4">
                  Let Us Help You
                </h2>
                <p className="text-[#747579] dark:text-gray-300 mb-4 text-sm">
                ...
                <ul className="space-y-3 mb-6">
                  {[
                    ...
                    <li key={index} className="flex items-center space-x-2">
                      <ArrowRight
                        className="text-[#066ac9] flex-shrink-0"
                        size={16}
                      />
                      <span className="text-[#747579] dark:text-gray-300 text-sm">
                        {item}
                      </span>
                    </li>
                  ))}
                ...
                <Button
                  variant="outline"
                  className="border-[#066ac9] text-[#066ac9] hover:bg-[#cde1f4] dark:hover:bg-[#031633] text-sm px-6 py-2"
                >
                  More about us
                </Button>
              </div>
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
              <div className="relative z-10">
                ...
                <p className="text-[#747579] dark:text-gray-300 mb-6 text-sm">
                  How promotion excellent curiosity yet attempted happiness Gay
                  prosperous impression had conviction For every delay death ask
        ...
        <section className="py-12 lg:py-16 px-6 lg:px-8">
          <div className="container mx-auto">
            <div className="bg-white dark:bg-[#24292d] border-white rounded-lg p-6 md:p-8 relative overflow-hidden">
              ...
              <div className="absolute top-0 left-0 -ml-7 hidden lg:block z-0">
                <svg
                  ...
                  className="fill-yellow-400 opacity-30"
                >
              ...
              <div className="relative z-20">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
                  ...
                  <div className="lg:col-span-6 text-center">
                    <h6 className="text-sm font-light text-[#747579] dark:text-gray-300 mb-2">
                      Get a Free Tutorial of
                    </h6>
                    <h3 className="text-xl md:text-2xl font-bold text-[#24292d] dark:text-white">
                      Exclusive Bootstrap 5 Responsive Website Coding Course
                    </h3>
                  </div>

                  <div className="lg:col-span-3 text-center lg:text-right">
                    <Button className="bg-yellow-500 hover:bg-yellow-600 text-white px-6 py-2 text-sm">
                      Get a free trial
                    </Button>
                  </div>
                </div>
        ...
        <section className="py-12 lg:py-16 px-6 lg:px-8 bg-white dark:bg-gray-800 relative">
          {/* Background decoration */}
          ...
          <div className="container mx-auto relative z-10">
            <div className="text-center mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-[#24292d] dark:text-white mb-3">
                Our Customer Feedback
              </h2>
              <p className="text-[#747579] dark:text-gray-300 text-sm">
