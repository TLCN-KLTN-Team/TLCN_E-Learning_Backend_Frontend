  ...
  useEffect(() => {
    ...
    const authenticateUser = async () => {
      try {
        ...
        if (!code) {
          toast.error("Không tìm thấy mã xác thực từ Facebook.");
        } else {
        ...
        <div className="text-center">
          ...
          <div className="flex items-center justify-center mb-8">
            <div className="relative">
              ...
              >
                {/* Ring với màu Facebook */}
                <div
                  className="absolute inset-0 rounded-full"
                  style={{
                    background: `conic-gradient(from 0deg, #1877f2 0deg 90deg, #42a5f5 90deg 180deg, #1976d2 180deg 270deg, #0d47a1 270deg 360deg)`,
                    padding: "3px",
                  }}
                >
          ...
          <div className="mb-8">
            ...
            {/* Dynamic Progress Bar với màu Facebook */}
          ...
          <div className="flex items-center justify-center text-sm text-gray-400 bg-gray-700 rounded-lg p-3">
            ...
            Kết nối an toàn với máy chủ Facebook
          </div>
        </div>
      </div>
    </div>
