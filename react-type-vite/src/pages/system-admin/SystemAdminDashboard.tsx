...
const SystemAdminDashboard: React.FC = () => {
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600">Tổng quan hệ thống đào tạo</p>
            </div>
            <SystemStatsCards />
            <SystemStatistics />
          </div>
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <SystemAdminSidebar activeSection={activeSection} setActiveSection={setActiveSection} />
      <div className="flex-1 flex flex-col ml-72 pl-6">
        <SystemAdminHeader />
