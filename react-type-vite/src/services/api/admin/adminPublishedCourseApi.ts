...
export const getPendingPublishedCourses = async (
  ...
  const response = await axiosInstance.get<ApiResponse<any>>(
    `/course-management/admin/educational-unit/${educationalUnitId}/published-courses/pending?page=${page}&size=${size}`
  );
...
export const getPublishedCourses = async (
  ...
  const response = await axiosInstance.get<ApiResponse<any>>(
    `/course-management/admin/educational-unit/${educationalUnitId}/published-courses?page=${page}&size=${size}${statusParam}`
  );
...
export const getPublishedCourseById = async (
  ...
  const response = await axiosInstance.get<ApiResponse<PublishedCourseResponse>>(
    `/course-management/admin/educational-unit/${educationalUnitId}/published-courses/${publishedCourseId}`
  );
...
export const approvePublishedCourse = async (
  ...
  const response = await axiosInstance.post<ApiResponse<PublishedCourseResponse>>(
    `/course-management/admin/educational-unit/${educationalUnitId}/published-courses/${publishedCourseId}/approve`
  );
...
export const rejectPublishedCourse = async (
  ...
  const response = await axiosInstance.post<ApiResponse<PublishedCourseResponse>>(
    `/course-management/admin/educational-unit/${educationalUnitId}/published-courses/${publishedCourseId}/reject?reason=${encodeURIComponent(reason)}`
  );
