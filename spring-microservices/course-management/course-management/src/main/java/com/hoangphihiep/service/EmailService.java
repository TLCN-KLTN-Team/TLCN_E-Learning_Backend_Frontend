...
public class EmailService {
    ...
    /**
     * Sends account credentials email asynchronously
     */
    @Async
    ...
    private String buildAccountCredentialsEmail(String firstName, String lastName,
        ...
        return """
            ...
            """.formatted(accountTypeVi, firstName, lastName, accountTypeVi, username, password, loginUrl);
    }
                ...
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <div class="warning">
                            ...
                            • Để bảo mật, liên kết này chỉ có thể sử dụng một lần
                        </div>
