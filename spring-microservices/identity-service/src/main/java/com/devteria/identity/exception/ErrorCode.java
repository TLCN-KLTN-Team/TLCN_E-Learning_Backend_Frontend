...
public enum ErrorCode {
    ...
    INVALID_ROLE("ROLE_7003", "Vai trò không hợp lệ", HttpStatus.BAD_REQUEST),
    ...
    ACCOUNT_NOT_VERIFIED(
            "OTP_1028", "Tài khoản chưa được xác thực. Vui lòng xác thực tài lại.", HttpStatus.BAD_REQUEST),
    INVALID_ACCOUNT_STATUS("OTP_1029", "Trạng thái tài khoản không hợp lệ cho thao tác này", HttpStatus.BAD_REQUEST),
